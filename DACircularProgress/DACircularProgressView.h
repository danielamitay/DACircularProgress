...
- (void)setProgress:(CGFloat)progress duration:(CGFloat)duration initialDelay:(CFTimeInterval)initialDelay animated:(BOOL)animated completion:(void (^)(void))blockCompleteion;
